...
class Model_videolar extends Model {
 ...
 public function videokat(){

       

        $sql = "SELECT * FROM Categori_VT where cattype='video'";
        ...
        return $this->db->select($sql);
         ...
         public function catust($upcatid){

        $sql = "SELECT * FROM Categori_VT where cattype='news' and id=".$upcatid." ";
