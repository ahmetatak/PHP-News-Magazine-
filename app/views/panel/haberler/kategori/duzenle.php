...
echo '<h5> Haber kategorisini düzenleme bölümü</h5>';





     foreach ($edit as $key => $catedit) {
...
<input type="hidden" id="id" name="id" value="'.$catedit["id"].'"/>
    ...
    <input type="hidden" id="sesid" name="sesid" value="'.  session_id().'"/>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="name"  value="'.$catedit["catname"].'" class="form-control" id="name" placeholder="Kategori adı">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-3">
      ...
      <input type="text" name="img"  value="'.$catedit["catimg"].'" class="form-control" id="img" placeholder="Kategori resmi">

    

</div><div class="col-sm-1 col-lg-1"><img class="img-responsive img-circle" src="'.$catedit["catimg"].'"></div>
   ...
   <div class="form-group ">
    ...
    <div class="col-sm-3">
      ...
      <textarea id="detay" name="detay" class="form-control">'.$catedit["catdetail"].'</textarea>

        </div><div class="col-md-6 col-sm-0">'.Response::warning('<p class="text-danger"> Eğer kategoriniz bir üst kategori ise lütfen alt kategorisine kayıt etmeyiniz ! Aksi halde sistemde gözükmeyecektir.<p>','no').'</div>
...
<div class="form-group">
    ...
    <label for="statu" class="col-sm-3 control-label">Kategori durumu : </label>

    <div class="col-sm-2">

<select name="durum" id="statu" class="form-control">

 

       <optgroup  selected label="'.$statu.'"> 
...
<input type="hidden" id="update" name="update" value="start"/>
