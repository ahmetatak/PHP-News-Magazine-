...
class yazar extends Controller {
...
public function liste ($controller, $method, $passid){

    

$yazar_model = $this->load->model("yazar");

$data["yazarlar"] = $yazar_model->liste();





    $this->load->view("yazar/liste","", $data,"news");   
